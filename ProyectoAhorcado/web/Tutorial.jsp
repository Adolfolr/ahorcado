...
<body id="capa">
    ...
    <p class="parrafo">El juego del ahorcado es un juego muy sencillo y divertido, consiste en adivinar una palabra, se van diciendo letras (consejo ¡Empezar por las vocales!) 
...
<ol class="parrafo">
    <li><b>Empecemos:</b> No esperemos más, nada más pulsar esta opción te llevará al fantástico juego del Ahorcado donde deberás clicar en los botones para ir dando posibles soluciones y así descubrir la palabra.</li>
